...
{
    public sealed partial class PretContent : ContentDialog
    {
        ...
        {
            //Pret p = new Pret( Int32.Parse(this.tBox2.Text), this.tBox3.Text, this.tBox4.Text, this.tBox5.Text, this.tBox6.Text, this.tBox7.Text);
